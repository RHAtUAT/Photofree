...
import { DesktopGallery, studioTheme, UploadWindow } from "./ui-components";
...
function App() {
  ...
  const [showPopup, setUploadWindow] = useState(false);

  const toggleUploadWindow = () => {
    setUploadWindow(!showPopup);
  }
  ...
  return (
    ...
    <>
      ...
      <DesktopGallery 
        overrides={{
          NavBar: {overrides:{Button: {onClick: toggleUploadWindow}}}
        }}/>
      <Modal
        open={showPopup}
